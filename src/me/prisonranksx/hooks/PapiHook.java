...
public class PapiHook extends PlaceholderExpansion {
	...
	public String onPlaceholderRequest(Player arg0, String arg1) {
		...
		if (is(arg1, "rankup_percentage")) {
			if (prxAPI.getPlayerNextRank(p) == null) {
				return main.getString(main.globalStorage.getStringData("PlaceholderAPI.rankup-percentage-lastrank"), arg0.getName());
			}
		...
		if (sw(arg1, "plaindecimal_")) {
			...
			return s(prxAPI.numberAPI.keepNumbersWithDots(prxAPI.numberAPI.deleteScientificNotationA(Double.parseDouble(bsed))));
		}
		if (sw(arg1, "plain_")) {
		...
		if(arg1.equalsIgnoreCase("rankup_progress_double")) {
			if(prxAPI.getPlayerNextRank(p) == null) {
				return main.getString(main.globalStorage.getStringData("PlaceholderAPI.rankup-progress-lastrank"), arg0.getName());
			}
			return String.valueOf(prxAPI.getPlayerRankupProgressBarExtended(p));
		}
		if(arg1.equalsIgnoreCase("rankup_name")) {
			if(prxAPI.getPlayerNextRank(p) == null) {
				return main.getString(main.globalStorage.getStringData("PlaceholderAPI.rankup-lastrank"), arg0.getName());
			}
		...
		if((arg1.equalsIgnoreCase("rankup_cost"))) {
			if(prxAPI.getPlayerNextRank(p) == null) {
				return main.getString(main.globalStorage.getStringData("PlaceholderAPI.rankup-cost-lastrank"), arg0.getName());
			}
		...
		if(arg1.startsWith("decimalformat_")) {
			try {
				double placeholderToFormat = Double.parseDouble(PlaceholderAPI.setBracketPlaceholders(p, (arg1.replace("decimalformat_", ""))));
		...
		if(arg1.equalsIgnoreCase("rebirth_name")) {
			if(!prxAPI.hasRebirthed(p)) {
				return main.getString(main.globalStorage.getStringData("PlaceholderAPI.rebirth-notrebirthed"), arg0.getName());
			}
		...
		if(arg1.equalsIgnoreCase("prestige_name")) {
			if(!prxAPI.hasPrestiged(p)) {
				return main.getString(main.globalStorage.getStringData("PlaceholderAPI.prestige-notprestiged"), arg0.getName());
			}
		...
		if(arg1.equalsIgnoreCase("nextrebirth_name")) {
			if(!prxAPI.hasRebirthed(p)) {
				return main.getString(main.globalStorage.getStringData("PlaceholderAPI.nextrebirth-notrebirthed"), arg0.getName());
			}
		...
		if(arg1.equalsIgnoreCase("nextprestige_name")) {
			if(!prxAPI.hasPrestiged(p)) {
				return main.getString(main.globalStorage.getStringData("PlaceholderAPI.nextprestige-notprestiged"), arg0.getName());
			}
			if(!prxAPI.hasNextPrestige(p)) {
				return main.getString(main.globalStorage.getStringData("PlaceholderAPI.prestige-lastprestige"), arg0.getName());
			}
	...
	public String onRequest(OfflinePlayer arg0, String arg1) {
		...
		if (is(arg1, "rankup_progress")) return prxAPI.getPlayerNextRank(p) == null || !main.isRankEnabled ? stringDataP("rankup-progress-lastrank", arg0) : s(prxAPI.getPlayerRankupProgressBar(p));
		if(arg1.startsWith("rank_progress_")) {
			if(arg1.startsWith("rank_progress_double_")) {
				String path = prxAPI.getPlayerRankPath(p).getPathName();
				String rank = arg1.replace("rank_progress_double_", "");
