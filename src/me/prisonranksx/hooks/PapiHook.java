...
public class PapiHook extends PlaceholderExpansion {
	...
	public void refreshValues(PrisonRanksX main) {
		this.main = main;
		prxAPI = this.main.prxAPI;
		lbm = this.main.lbm;
		nullNameRank = this.main.globalStorage.getStringData("PlaceholderAPI.leaderboard-name-rank-null");
	...
	public String onPlaceholderRequest(Player arg0, String arg1) {
		...
		if (sw(arg1, "current_displayname_customspace_"))
			return prxAPI.getStageDisplay(p.getPlayer(), swr(arg1, "current_displayname_customspace_"), true);
		if (is(arg1, "currentrank_name")) return prxAPI.isLastRank(p) && boolDataP("currentrank-lastrank-enabled")
				? stringDataP("currentrank-lastrank", arg0) : s(prxAPI.getPlayerRank(p));
		if (sw(arg1, "currentrank_name_"))
			return swp(arg1, "currentrank_name_", "null", player -> prxAPI.getPlayerRank(player));
		if (is(arg1, "currentrank_displayname"))
			return prxAPI.isLastRank(p) && boolDataP("currentrank-lastrank-enabled")
					? stringDataP("currentrank-lastrank", arg0) : s(prxAPI.getPlayerRankDisplay(p));
		if (is(arg1, "currentrank_firstcolor"))
			return s(MCTextEffect.getColorCodesAfterChar(prxAPI.getPlayerRankDisplay(p), 0));
		if (is(arg1, "currentrank_lastchar"))
			return s(prxAPI.getPlayerRankDisplay(p).charAt(prxAPI.getPlayerRankDisplay(p).length() - 1));
		...
		if (is(arg1, "rankup_percentage")) {
			if (prxAPI.getPlayerNextRank(p) == null) {
				return main.getString(main.globalStorage.getStringData("PlaceholderAPI.rankup-percentage-lastrank"),
						arg0.getName());
			}
		...
		if (is(arg1, "rankup_percentage_plain"))
			return prxAPI.getPlayerNextRank(p) == null ? "100" : s(prxAPI.getPlayerRankupPercentageDirect(p));
		if (sw(arg1, "plaindecimal_")) {
			...
			return s(prxAPI.numberAPI
					.keepNumbersWithDots(prxAPI.numberAPI.deleteScientificNotationA(Double.parseDouble(bsed))));
		}
		if (sw(arg1, "plain_")) {
		...
		if (sw(arg1, "integerize_")) {
			String integerize = PlaceholderAPI.setBracketPlaceholders(p,
					prxAPI.numberAPI.keepNumbersWithDots(swr(arg1, "integerize_")));
			if (prxAPI.numberAPI.isNumber(integerize)) {
				double val = Double.parseDouble(integerize);
		...
		if (sw(arg1, "usformat_")) {
			...
			return nf.format(Double.parseDouble(bsed));
		}
		...
		if (is(arg1, "rankup_progress")) return prxAPI.getPlayerNextRank(p) == null
				? stringDataP("rankup-progress-lastrank", arg0) : s(prxAPI.getPlayerRankupProgressBar(p));
		...
		if (arg1.equalsIgnoreCase("rankup_progress_double")) {
			if (prxAPI.getPlayerNextRank(p) == null) {
				return main.getString(main.globalStorage.getStringData("PlaceholderAPI.rankup-progress-lastrank"),
						arg0.getName());
			}
		...
		if (arg1.equalsIgnoreCase("rankup_name")) {
			if (prxAPI.getPlayerNextRank(p) == null) {
				return main.getString(main.globalStorage.getStringData("PlaceholderAPI.rankup-lastrank"),
						arg0.getName());
			}
		...
		if ((arg1.equalsIgnoreCase("rankup_cost"))) {
			if (prxAPI.getPlayerNextRank(p) == null) {
				return main.getString(main.globalStorage.getStringData("PlaceholderAPI.rankup-cost-lastrank"),
						arg0.getName());
			}
			if (prxAPI.isCurrencySymbolBehind()) {
				return String.valueOf(prxAPI.getPlaceholderAPICurrencySymbol())
						+ String.valueOf(prxAPI.getPlayerRankupCostWithIncreaseDirect(p));
			} else {
				return String.valueOf(prxAPI.getPlayerRankupCostWithIncreaseDirect(p))
						+ String.valueOf(prxAPI.getPlaceholderAPICurrencySymbol());
			}
		}
		if ((arg1.equalsIgnoreCase("rankup_cost_integer"))) {
			...
			if (prxAPI.isCurrencySymbolBehind()) {
				return String.valueOf(prxAPI.getPlaceholderAPICurrencySymbol()) + String
						.valueOf(prxAPI.numberAPI.toFakeInteger(prxAPI.getPlayerRankupCostWithIncreaseDirect(p)));
			} else {
		...
		if ((arg1.equalsIgnoreCase("rankup_cost_plain"))) {
			...
			return String.valueOf(
					prxAPI.numberAPI.deleteScientificNotationA(prxAPI.getPlayerRankupCostWithIncreaseDirect(p)));
		}
		...
		if ((arg1.equalsIgnoreCase("rankup_cost_formatted"))) {
			...
			if (prxAPI.isCurrencySymbolBehind()) {
				return String.valueOf(prxAPI.getPlaceholderAPICurrencySymbol()) + String.valueOf(
						prxAPI.getPluginMainClass().formatBalance(prxAPI.getPlayerRankupCostWithIncreaseDirect(p)));
			} else {
				return String.valueOf(
						prxAPI.getPluginMainClass().formatBalance(prxAPI.getPlayerRankupCostWithIncreaseDirect(p)))
						+ String.valueOf(prxAPI.getPlaceholderAPICurrencySymbol());
		...
		if (arg1.startsWith("decimalformat_")) {
			try {
				double placeholderToFormat = Double
						.parseDouble(PlaceholderAPI.setBracketPlaceholders(p, (arg1.replace("decimalformat_", ""))));
		...
		if ((arg1.equalsIgnoreCase("money"))) {
			return String
					.valueOf(prxAPI.getPluginMainClass().formatBalance(prxAPI.getPluginMainClass().econ.getBalance(p)));
		}
		if (arg1.equalsIgnoreCase("rebirth_name")) {
			if (!prxAPI.hasRebirthed(p)) {
				return main.getString(main.globalStorage.getStringData("PlaceholderAPI.rebirth-notrebirthed"),
						arg0.getName());
			}
		...
		if (arg1.equalsIgnoreCase("prestige_name")) {
			if (!prxAPI.hasPrestiged(p)) {
				return main.getString(main.globalStorage.getStringData("PlaceholderAPI.prestige-notprestiged"),
						arg0.getName());
			}
		...
		if (arg1.equalsIgnoreCase("prestige_number_formatted")) {
			...
			if (main.isInfinitePrestige) {
				return String.valueOf(prxAPI.formatBalance(Double.parseDouble(prxAPI.getPlayerPrestige(p))));
			}
		...
		if (arg1.equalsIgnoreCase("prestige_displayname_usformat")) {
			...
			if (main.isInfinitePrestige) {
				return main.getString(main.infinitePrestigeSettings
						.getNonReplacedDisplay(prxAPI.getPrestige(prxAPI.getPlayerPrestige(p)))
						.replace("{number}", nf.format(Long.valueOf(prxAPI.getPlayerPrestige(p)))));
			}
		...
		if (arg1.equalsIgnoreCase("prestige_cost")) {
			...
			if (prxAPI.isCurrencySymbolBehind()) {
				return String.valueOf(prxAPI.getPlaceholderAPICurrencySymbol())
						+ String.valueOf(prxAPI.getPlayerPrestigeCost(p));
			} else {
		...
		if (arg1.equalsIgnoreCase("prestige_cost_formatted")) {
			...
			if (prxAPI.isCurrencySymbolBehind()) {
				return String.valueOf(prxAPI.getPlaceholderAPICurrencySymbol())
						+ String.valueOf(prxAPI.getPlayerPrestigeCostFormatted(p));
			} else {
				return String.valueOf(prxAPI.getPlayerPrestigeCostFormatted(p))
						+ String.valueOf(prxAPI.getPlaceholderAPICurrencySymbol());
			}
		}
		if (arg1.equalsIgnoreCase("nextrebirth_name")) {
			if (!prxAPI.hasRebirthed(p)) {
				return main.getString(main.globalStorage.getStringData("PlaceholderAPI.nextrebirth-notrebirthed"),
						arg0.getName());
			}
			if (!prxAPI.hasNextRebirth(p)) {
				return main.getString(main.globalStorage.getStringData("PlaceholderAPI.rebirth-lastrebirth"),
						arg0.getName());
			}
		...
		if (arg1.equalsIgnoreCase("nextprestige_name")) {
			if (!prxAPI.hasPrestiged(p)) {
				return main.getString(main.globalStorage.getStringData("PlaceholderAPI.nextprestige-notprestiged"),
						arg0.getName());
			}
			if (!prxAPI.hasNextPrestige(p)) {
				return main.getString(main.globalStorage.getStringData("PlaceholderAPI.prestige-lastprestige"),
						arg0.getName());
			}
		...
		if (arg1.equalsIgnoreCase("nextprestige_cost")) {
			...
			if (prxAPI.isCurrencySymbolBehind()) {
				return String.valueOf(prxAPI.getPlaceholderAPICurrencySymbol())
						+ String.valueOf(prxAPI.getPlayerNextPrestigeCostWithIncreaseDirect(p));
			} else {
		...
		if (arg1.equalsIgnoreCase("nextprestige_cost_integer")) {
			...
			if (prxAPI.isCurrencySymbolBehind()) {
				return String.valueOf(prxAPI.getPlaceholderAPICurrencySymbol()) + String
						.valueOf(prxAPI.numberAPI.toFakeInteger(prxAPI.getPlayerNextPrestigeCostWithIncreaseDirect(p)));
			} else {
				return String
						.valueOf(prxAPI.numberAPI.toFakeInteger(prxAPI.getPlayerNextPrestigeCostWithIncreaseDirect(p))
								+ String.valueOf(prxAPI.getPlaceholderAPICurrencySymbol()));
		...
		if (arg1.equalsIgnoreCase("nextprestige_cost_plain")) {
			return String.valueOf(
					prxAPI.numberAPI.deleteScientificNotationA(prxAPI.getPlayerNextPrestigeCostWithIncreaseDirect(p)));
		}
		...
		if (arg1.equalsIgnoreCase("nextrebirth_cost")) {
			...
			if (prxAPI.isCurrencySymbolBehind()) {
				return String.valueOf(prxAPI.getPlaceholderAPICurrencySymbol())
						+ String.valueOf(prxAPI.getPlayerNextRebirthCost(p));
			} else {
		...
		if (arg1.equalsIgnoreCase("nextrebirth_cost_integer")) {
			...
			if (prxAPI.isCurrencySymbolBehind()) {
				return String.valueOf(prxAPI.getPlaceholderAPICurrencySymbol())
						+ String.valueOf(prxAPI.numberAPI.toFakeInteger(prxAPI.getPlayerNextRebirthCost(p)));
			} else {
		...
		if (arg1.equalsIgnoreCase("nextprestige_cost_formatted")) {
			...
			if (prxAPI.isCurrencySymbolBehind()) {
				return String.valueOf(prxAPI.getPlaceholderAPICurrencySymbol())
						+ String.valueOf(main.formatBalance(prxAPI.getPlayerNextPrestigeCostWithIncreaseDirect(p)));
			} else {
				return String.valueOf(main.formatBalance(prxAPI.getPlayerNextPrestigeCostWithIncreaseDirect(p)))
						+ String.valueOf(prxAPI.getPlaceholderAPICurrencySymbol());
			}
		}
		if (arg1.equalsIgnoreCase("nextrebirth_cost_formatted")) {
			...
			if (prxAPI.isCurrencySymbolBehind()) {
				return String.valueOf(prxAPI.getPlaceholderAPICurrencySymbol())
						+ String.valueOf(main.formatBalance(prxAPI.getPlayerNextRebirthCost(p)));
			} else {
				return String.valueOf(main.formatBalance(prxAPI.getPlayerNextRebirthCost(p)))
						+ String.valueOf(prxAPI.getPlaceholderAPICurrencySymbol());
			}
		}
	...
	public String onRequest(OfflinePlayer arg0, String arg1) {
		...
		if (is(arg1, "currentrank_name")) return prxAPI.isLastRank(p) && boolDataP("currentrank-lastrank-enabled")
				? stringDataP("currentrank-lastrank", arg0) : s(prxAPI.getPlayerRank(p));
		if (sw(arg1, "currentrank_name_")) return swp(arg1, "currentrank_name_", "null", prxAPI::getPlayerRank);
		if (is(arg1, "currentrank_displayname"))
			return prxAPI.isLastRank(p) && boolDataP("currentrank-lastrank-enabled")
					? stringDataP("currentrank-lastrank", arg0) : s(prxAPI.getPlayerRankDisplay(p));
		if (is(arg1, "currentrank_firstcolor"))
		...
		if (is(arg1, "rankup_progress")) return prxAPI.getPlayerNextRank(p) == null || !main.isRankEnabled
				? stringDataP("rankup-progress-lastrank", arg0) : s(prxAPI.getPlayerRankupProgressBar(p));
		if (arg1.startsWith("rank_progress_")) {
			if (arg1.startsWith("rank_progress_double_")) {
				String path = prxAPI.getPlayerRankPath(p).getPathName();
		...
		if (arg1.equalsIgnoreCase("prestige_number_old")) {
			if (!prxAPI.hasPrestiged(p)) {
				return main.getString(main.globalStorage.getStringData("PlaceholderAPI.prestige-notprestiged"),
						arg0.getName());
			}
	...
	private String swp(String arg1, String unwanted, String notOnlineResult,
			Function<Player, String> onlineFunctionResult) {
	...
	private String s(Object obj) {
		return main.getString(String.valueOf(obj));
	}
