...
public class ChatColorReplacer1_16 implements ChatColorReplacer {
	...
	private GlobalDataStorage globalStorage;
	
	public ChatColorReplacer1_16(PrisonRanksX main) {
		this.main = main;
		this.globalStorage = this.main.getGlobalStorage();
	}
	
	private String c(String textToTranslate) {	
		return ChatColor.translateAlternateColorCodes('&', this.globalStorage.translateHexColorCodes(textToTranslate));
	}
