...
public class RankDataStorage {
	...
	public RankDataStorage(PrisonRanksX main) {
		this.main = main;
		this.rankData = new LinkedHashMap<>();
	...
	public void saveRankData(RankPath rankPath) {
		...
		RankDataHandler handler = rankData.get(rankPath.get());
		setData("Ranks." + pathName + "." +  rankName + ".nextrank", handler.getRankupName());
		setData("Ranks." + pathName + "." +  rankName + ".cost", handler.getCost());
		setData("Ranks." + pathName + "." +  rankName + ".display", handler.getDisplayName());
		setData("Ranks." + pathName + "." +  rankName + ".allow-prestige", handler.isAllowPrestige());
		...
		setData("Ranks." + pathName + "." + rankName + ".delpermission", handler.getDelPermissionList());
	}
	...
	public void saveRanksData() {
		...
		for(Entry<String, RankDataHandler> rank : rankData.entrySet()) {
			...
			RankDataHandler handler = rank.getValue();
			setData("Ranks." + pathName + "." +  rankName + ".nextrank", handler.getRankupName());
			setData("Ranks." + pathName + "." +  rankName + ".cost", handler.getCost());
			setData("Ranks." + pathName + "." +  rankName + ".display", handler.getDisplayName());
			setData("Ranks." + pathName + "." +  rankName + ".allow-prestige", handler.isAllowPrestige());
			...
			setData("Ranks." + pathName + "." +  rankup + ".addpermission", handler.getAddPermissionList());
			setData("Ranks." + pathName + "." +  rankup + ".delpermission", handler.getDelPermissionList());
			setData("Ranks." + pathName + "." +  rankup + ".send-firework", handler.isSendFirework());
		}
	}
	...
	public boolean isLastRank(String pathName, String rankName) {
		return getLastRankMap().get(pathName).equalsIgnoreCase(rankName);
	}
