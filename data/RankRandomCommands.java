...
public class RankRandomCommands {
	...
	public RankRandomCommands(String rankName, boolean withKeys, String pathName) {
		this.setRankName(rankName); this.withKeys = withKeys; this.setPathName(pathName);
	...
	public RankRandomCommands(String rankName, boolean withKeys, String pathName, boolean loadSections) {
		this.setRankName(rankName); this.withKeys = withKeys; this.setPathName(pathName);
		this.commandsList = CollectionUtils.EMPTY_STRINGLIST_LIST;
		this.chances = CollectionUtils.EMPTY_DOUBLE_LIST;
		this.randomCommandsMap = CollectionUtils.EMPTY_STRING_TO_OBJECT_MAP;
